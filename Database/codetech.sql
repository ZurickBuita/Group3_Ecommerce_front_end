...
--
-- Host: 127.0.0.1
-- Generation Time: May 18, 2023 at 12:30 PM
...
(12, 'zurick', '09163443232', 'zurick@gmail.com', 'zurick', 'defaultImg.jpg');
...
INSERT INTO `orders` (`orderId`, `status`, `createdAt`, `packageId`, `customerId`, `paymentMethod`, `pinCode`, `message`, `serviceId`) VALUES
(15, 4, '2023-05-17 01:45:09', 110, 11, 1, 222222, 'sample message', 33),
(16, 4, '2023-05-17 02:19:21', 107, 11, 1, 44455, 'sample message', 32);
...
--
ALTER TABLE `messages`
  MODIFY `mssgId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
...
--
ALTER TABLE `project_proposal`
  MODIFY `proposalId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT for table `proofofpayment`
--
ALTER TABLE `proofofpayment`
  MODIFY `popId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
