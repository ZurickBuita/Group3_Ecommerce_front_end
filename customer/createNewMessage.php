...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    if (isset($_POST['createNewMssg'])) {
        ...
        if (!empty($_SESSION['proposalId']) && !empty($_SESSION['serviceId'])) {
            $projectId = $_SESSION['proposalId'];
            $serviceId = $_SESSION['serviceId'];
        }
        if ($_SESSION['packageId'] == null) {
            $query = "INSERT INTO `messages`(`mssgSubj`, `mssgTo`, `mssgFrom`, `mssgContent`, `mssgFile`, `projectId`)
            VALUES ('$mssgSubj','$mssgTo','$mssgFrom','$mssgContent','$fileUrl', '$projectId')";
        } else {
            $packageId = $_SESSION['packageId'];
            $serviceId = $_SESSION['serviceId'];
            echo "<script>alert('". $serviceId . "')</script>";
            $query = "INSERT INTO `messages`(`mssgSubj`, `mssgTo`, `mssgFrom`, `mssgContent`, `mssgFile`, `projectId`, `packageId`, `serviceId`)
            VALUES ('$mssgSubj','$mssgTo','$mssgFrom','$mssgContent','$fileUrl', '$projectId', '$packageId', '$serviceId')";
        }
