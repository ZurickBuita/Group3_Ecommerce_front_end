...
$isDelivered = $_SESSION['deliveredWork'];
...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    if (isset($_POST['createNewMssg'])) {
        ...
        VALUES ('$mssgSubj', '$mssgTo', '$customerId', '$mssgContent', '$fileUrl', '0', '$serviceId', '$packageId', '$orderId')";
...
<head>
    ...
    <title>CodeTech | Order Message</title>
