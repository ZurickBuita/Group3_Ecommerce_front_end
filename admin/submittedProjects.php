...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['mssgBtn'])) {
        ...
        $_SESSION['previousDir'] = "submittedProjects.php";
...
<head>
    ...
    <title>CodeTech Admin|Submitted Projects</title>
...
<body class="position-relative">
    ...
    <main id="main" class="main pb-5 mb-5">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Submitted Projects</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        <?php echo $alertMssg ?>
        ...
        INNER JOIN category ON project_proposal.projectCategory = category.categoryId) WHERE `status` = '3';";
        $query_run = mysqli_query($conn, $query);
                ...
                <div class="row g-3 d-flex align-items-center justify-content-between">
                    ...
                    <div class="col-md-6 col-sm-12 text-end">
                        <form class="d-inline" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>"
                            method="POST">
                            <button type="submit" class="acceptBtn btn btn-warning" value="<?= $data['proposalId'] ?>"
                                name="mssgBtn">Re-Upload</button>
                        </form>
