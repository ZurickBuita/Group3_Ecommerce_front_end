...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['acceptBtn'])) {
        ...
        $query = "UPDATE `project_proposal` SET `status`='1' WHERE `proposalId`='$proposalId'";
        $query_run = mysqli_query($conn, $query);
    ...
    if (isset($_POST['mssgBtn'])) {
        ...
        $_SESSION['previousDir'] = "projectProposal.php";
...
<body class="position-relative">
    ...
    <main id="main" class="main pb-5 mb-5">
        ...
        INNER JOIN category ON project_proposal.projectCategory = category.categoryId) WHERE `status` = '0';";
        $query_run = mysqli_query($conn, $query);
